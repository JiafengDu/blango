class PostRow extends React.Component {
  render () {
    ...
    if (post.hero_image.thumbnail) {
      thumbnail = <img src={post.hero_image}/>
    } else {
      thumbnail = '-'
    }
    ...
    return <tr>
      ...
      <td>{post.slug}</td>
      <td>{post.summary}</td>
      <td><a href={'/post/' + post.slug + '/'}>Views</a></td>
    </tr>
  }
}
      ...
      results: [
        {
          ...
          'hero_image': {
            'thumbnail': '/media/__size__/hero_images/snake-419043_1920-thumbnail-100x100-70.jpg',
            'full_size': 'media/hero_images/snake-419043-1920.jpg'
          },
          title: 'Test Post',
          slug: 'test-post',
